...
exports.getScanTags = function(req, res) {
    console.log("REceived the call !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    var productModel = mongoose.model('trackingScan');
    
//var url_parts = url.parse(req.url, true);
//var productId = url_parts.productId;
var productId = req.body.product_id;
console.log("product id"+productId);
    productModel.find({product_id:productId}).exec(function(err, result) {
...
exports.getSellerStore = function(req, res) {
    console.log("REceived the call !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    var productModel = mongoose.model('StoresDetail');
...
console.log("sellerid"+sellerid)
    ...
    productModel.find({seller_id:sellerid}).exec(function(err, result) {
